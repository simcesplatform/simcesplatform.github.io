...
| Variable name         | Default | Description                                  |
| --------------------- | ------- | -------------------------------------------- |
| RABBITMQ_DEFAULT_USER |         | The username for the local RabbitMQ instance |
| RABBITMQ_DEFAULT_PASS |         | The password for the local RabbitMQ instance |
...
| Variable name              | Default | Description |
| -------------------------- | ------- | ----------- |
| MONGO_INITDB_ROOT_USERNAME |         | The username for root access to the local MongoDB instance |
...
| ME_CONFIG_MONGODB_ADMINUSERNAME |                | The admin username for MongoDB. |
